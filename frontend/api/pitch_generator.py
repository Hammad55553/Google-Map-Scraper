...
Professional, fast and mobile-friendly websites, landing pages and e-commerce stores.
...
مرحباً فريق *{business_name}*! 👋

نحن *Asper InfoTech*، فريق تطوير برمجيات. نحن نبني حلولاً رقمية مخصصة للشركات - من المواقع البسيطة إلى أنظمة إدارة الأعمال المتكاملة.

*🚀 ما نقدمه*
*🌐 مواقع الويب والمتاجر الإلكترونية*
مواقع احترافية وسريعة ومتوافقة مع الهواتف المحمولة.
...
*🤖 روبوتات محادثة واتساب والذكاء الاصطناعي*
أتمتة دعم العملاء والأسئلة الشائعة والحجوزات.

*⚙️ برمجيات مخصصة*
هل لديك فكرة معينة؟ نحن نبني ما يحتاجه عملك بالضبط.

*💰 أسعار مناسبة ومرنة*
أسعارنا مرنة ومناسبة للغاية. يمكننا مناقشة متطلباتك وتقديم باقة مناسبة لميزانيتك.

*🎯 لماذا Asper InfoTech؟*
✓ فريق تطوير ذو خبرة
✓ أسعار مناسبة وشفافة
✓ تسليم سريع
...
*🌐 Websites & Online Stores*
Professional, fast aur mobile-friendly websites aur e-commerce stores.
...
*🤖 WhatsApp & AI Chatbots*
Customer support, FAQs, aur bookings ko automate karein.

*⚙️ Custom Software*
Koi specific idea hai? Aapke business ko jo chahiye, hum bilkul wesa hi banayenge.

*💰 Affordable & Flexible*
Hamari pricing flexible aur affordable hai. Hum aapki requirements discuss karke aapke budget ke mutabiq package de sakte hain.
...
پروفیشنل، تیز اور موبائل فرینڈلی ویب سائٹس اور ای کامرس اسٹورز۔
...
*🤖 واٹس ایپ اور AI چیٹ بوٹس*
کسٹمر سپورٹ، عمومی سوالات اور بکنگز کو آٹومیٹ کریں۔

*⚙️ کسٹم سافٹ ویئر*
کیا آپ کے پاس کوئی خاص آئیڈیا ہے؟ ہم بالکل وہی بنائیں گے جس کی آپ کے کاروبار کو ضرورت ہے۔

*💰 مناسب اور لچکدار قیمتیں*
ہماری قیمتیں لچکدار اور انتہائی مناسب ہیں۔ ہم آپ کی ضروریات پر بات کر کے آپ کے بجٹ کے مطابق بہترین پیکج دے سکتے ہیں۔

*🎯 Asper InfoTech کیوں؟*
✓ تجربہ کار ڈیویلپمنٹ ٹیم
...
*Asper InfoTech ٹیم*"""
    ...
    final_pitch = english_pitch
    
    if "saudi" in country_lower or "arab" in country_lower or "uae" in country_lower or "emirates" in country_lower or "dubai" in country_lower or "qatar" in country_lower or "oman" in country_lower or "kuwait" in country_lower or "bahrain" in country_lower:
        final_pitch += arabic_pitch
    elif "pakistan" in country_lower or "india" in country_lower:
        final_pitch += urdu_pitch
